...
echo "Build of components complete. Begin integration into bare docker container."
popd >/dev/null

# ==============================================================================
# -- Build OSTAR Bare Container ------------------------------------------------
# ==============================================================================

docker build -t ostar:synergies_container -f util/dockerfiles/DockerfileSynergiesContainer .
